...
<body style="padding:10px;">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="url" value="{$url.url}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">相册集</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="album_id" value="{$url.album_id}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">描述</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="description" value="{$url.description}">
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
        ...
        function save(){
            $.post('/admin.php/Index/edits',$('form').serialize(),function(res){
                if(res.code>0){
