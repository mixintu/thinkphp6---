...
<div class="site-content">
    ...
    <div class="site-text">
      ...
      <pre class="layui-code layui-box layui-code-view"><h3 class="layui-code-h3">code<a href="http://www.layui.com/doc/modules/code.html" target="_blank">layui.code</a></h3><ol class="layui-code-ol"><li>从 layui 2.3.0 开始，支持 font-class 的形式定义图标：</li><li>&lt;i class="layui-icon layui-icon-face-smile"&gt;&lt;/i&gt;   </li><li>      <pre class="layui-code layui-box layui-code-view"><h3 class="layui-code-h3">code<a href="http://www.layui.com/doc/modules/code.html" target="_blank">layui.code</a></h3><ol class="layui-code-ol"><li>注意：在 layui 2.3.0 之前的版本，只能设置 unicode 来定义图标</li><li>&lt;i class="layui-icon"&gt;&amp;#xe60c;&lt;/i&gt;   </li><li>其中的 &amp;#xe60c; 即是图标对应的 unicode 字符</li><li>       </li></ol></pre></li><li> </li><li>你可以去定义它的颜色或者大小，如：<i class="layui-icon layui-icon-face-smile" style="font-size: 30px; color: #FF5722;"></i>  </li><li>&lt;i class="layui-icon layui-icon-face-smile" style="font-size: 30px; color: #1E9FFF;"&gt;&lt;/i&gt;  </li><li>      </li></ol></pre>
    </div>
    ...
    <ul class="site-doc-icon">
      ...
      <li>
        ...
        <div class="doc-icon-code">&amp;#xe616</div>
