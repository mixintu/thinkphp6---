          ...
          <tbody>
              ...
              {volist name="right" id="right_v"}
                  <tr>
                      ...
                      <td>
                        <div id="div1">
                            <img src="__IMG__/{$right_v.url}" height="40px" width="50px">
                        </div>
                      </td>
...
<script type="text/javascript">
        ...
        function add(){
            layer.open({
                ...
                shade: 0.3,
                area: ['480px', '440px'],
                content: '/admin.php/ScreenshotPictures/add'
            });
        }
        // 编辑按钮
        function edit(id){
            layer.open({
                ...
                shade: 0.3,
                area: ['480px', '440px'],
                content: '/admin.php/ScreenshotPictures/edit?id='+id
            });
        }
        // 删除按钮
        function del(id){
            layer.confirm('确定要删除吗？', {
                ...
                $.post('/admin.php/ScreenshotPictures/del',{'id':id},function(res){
                    if(res.code>0){
